Inputs: NoS(2),LenL(53),KL(1.92),LenS(5),KS(1.96),ADXLen(14),ADXLimit(30),alfa(.2),maxtrades(4);
Inputs: StopL(800),StopS(1000),MinMCP(50),BRK(800),TL(1900),TS(800),TL1(5200),TS1(4100);

Vars: upperk(0,data2),lowerk(0,data2),adxval(0,data2),mcp(0),engine(true,data2),el(true,data2),es(true,data2),trades(0);
