...
{***************************}
{***************************}
input: tal(0.58),sal(0.45),kal(0.25);
input: tas(0.20),sas(0.15),kas(0.05);

input: stopl(4000),funkl(4800),brkl(100000),tl(100000);
input: stops(3300),funks(4400),brks(100000),ts(100000);
