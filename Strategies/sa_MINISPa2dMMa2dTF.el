Inputs: nos(2),alphal(0.07),flenl(8),rngpctl(0.15),alphas(0.07),flens(8),rngpcts(.15),mnymngmnt(0);
Inputs: stopl(100000),stopdl(100000),modl(100000),tld(100000),tl(100000);
Inputs: stops(100000),stopds(100000),mods(100000),tsd(100000),ts(100000);
