...
Vars: upk(0,data2),lok(0,data2),adxval(0,data2),el(true,data2),es(true,data2),engine(true,data2),trades(0);
vars: stopval(0),minstop(-1),maxstop(999999),stp(false),mkt(false),mcp(0),yc(0),daylimit(7000/bigpointvalue);
...
if engine and trades < 2 and adxval < adxlimit then begin
