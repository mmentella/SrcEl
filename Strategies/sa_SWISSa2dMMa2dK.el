Inputs: nos(2),lenl(54),kl(3.869),lens(15),ks(5.71),adxlen(14),adxlimit(30),mnymngmnt(0);
Inputs: stopl(100000),stopdl(100000),brkl(100000),modl(1800),tl(6000),tld(100000),trsl(100000);
Inputs: stops(100000),stopds(1800),brks(100000),mods(1650),ts(2800),tsd(100000),trss(100000);
