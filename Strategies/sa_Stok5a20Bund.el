...
Input: Len(7), Mov(100), Nos(2), MaxstopL(0.985), MaxstopS(1.014), len1(2.4), len2(2);
Var: intrabarpersist MXL(0), intrabarpersist MXS(0), flag(false), 
intrabarpersist tgl(0), intrabarpersist tgs(0);
...
tgl = entryprice + len1*avgtruerange(5) data2;  
tgs = entryprice - len2*avgtruerange(5) data2; 
...
and Condition6 Then sellshort ("Sell1") nos shares next bar at market;
...
if T > sess1firstbartime and T <= 2150 then begin
