...
Inputs: stops(1850),stopds(1400),mods(2250),tsd(2300),ts(3450);
//Inputs: stopl(2000),stopdl(1850),modl(1700),tld(3600),tl(4800);
//Inputs: stops(1850),stopds(1750),mods(2250),tsd(2300),ts(3450);
