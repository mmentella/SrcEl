...
//condition1 = d < 1080714 or d > 1090801;
//if d = 1080714 then setexitonclose;

if trade and 800 < t and t < 2300 then begin
 if marketposition < 1 and engl then buy nos shares next bar at entrylong limit; 
 if marketposition > -1 and engs then sellshort nos shares next bar at entryshort limit;
end;
