Inputs: nos(2),alphal(.017),flenl(45),rngpctl(.315),alphas(.386),flens(23),rngpcts(.69);
Inputs: stopl(1000000),stopdl(1000000),stops(1000000),stopds(1000000),brkl(1000000),brks(1000000),modl(1000000),mods(1000000),tl(1000000),ts(1000000);
...
if d < 1201212 or d > 0 then begin
