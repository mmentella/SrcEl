Inputs: nos(2),alphtl(.217),alphcl(.135),rngpctl(.276),alphts(.009),alphcs(.008),rngpcts(.067),mnymngmnt(0);
Inputs: stopl(550),stopdl(3550),brkl(1000000{950}),modl(1000000{1250}{2650}),tl(1000000),tld(1000000),trsl(1000000);
Inputs: stops(850),stopds(1600),brks(400{1250}),mods(1000000),ts(1000000),tsd(1000000),trss(1000000);
Inputs: stopperc(0);
...
//if d < 1071231 or 1090101 < d then begin
if trade then begin
