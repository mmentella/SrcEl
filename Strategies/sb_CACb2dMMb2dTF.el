{******** - MM.G1.B.DAX - **********
 ...
 Portfolio: G1
 Market:    DAX
 TimeFrame: 60 min. / 840 min.
 BackBars:  50
 Date:      17 Gen 2011
**************************************}
Inputs: alphal(0.07),flenl(8),rngpctl(0.1),alphas(0.07),flens(8),rngpcts(.1),mnymngmnt(0);
...
vars: stpv(0),mkt(true),stp(true),trades(0),dru(0),funk(false);
{*************************************}
{*************************************}
if d <> d[1] then begin
 trades = 0;
