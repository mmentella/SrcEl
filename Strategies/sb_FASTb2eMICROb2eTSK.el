...
{***************************}
{***************************}
input: tal(0.30),sal(0.85),kal(0.05);
input: tas(0.75),sas(0.65),kas(0.05);
input: maxtrades(100);
{
input: stopl(195),funkl(255),brkl(150),tl(335);
input: stops(255),funks(270),brks(210),ts(430);
}
