Inputs:NoS(2),LenL(156),FactorL(.75),LenS(540),FactorS(1.6);

Inputs: ATRLen(252),ATRl(7), ATRs(4),KLenL(96),AKLenL(120),KLenS(60),AKLenS(156),MinLen(36),MaxLen(528);

Inputs: SLoss(2000),PTarget(1800),SOD(1100),EOD(2200),ADXLen(216),ADXLimit(30);
...
End
else Buy to Cover ("ATR-XS eb") NoS shares Next bar at Low + ATRVal Stop;
...
End
else Sell ("ATR-XL eb") NoS shares Next bar at High - ATRVal Stop;
