{******** - MM.DICICCO.COCOA - **********
 ...
 Date:      13 Set 2010
*************************************}
vars: nos(2),lenl(20),lens(22),kl(2.553),ks(4.981),stochlen(18),os(21),ob(74),alpha(.21);
vars: stopl(1350),stopdl(650 ),modl(1100),tl(4100),tld(2000),trsl(1400);
vars: stops(1050),stopds(1350),mods(1300),ts(1950),trss(1300);

vars: upk(0),lok(0),stochval(0),bs(true),ss(true),trades(0);
