{****** - MM.RA.SKEW.NASDAQ - ********
 ...
 Date:      28 Lug 2011
**************************************}
inputs: alphal(0.64),alpml(0.14),alpdl(0.68);
inputs: alphas(0.25),alpms(0.03),alpds(0.08);
inputs: stopl(100000),funkl(100000),brkl(100000),modl(100000),tl(100000);
inputs: stops(100000),funks(100000),brks(100000),mods(100000),ts(100000);
...
{***************************}
{***********ENGINE**********}
{condition1 = d < 1070401 or 1090301 < d;
