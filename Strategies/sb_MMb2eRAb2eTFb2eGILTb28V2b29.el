...
{*************************************}
{*************************************}
vars: alphal(0.43),flenl(7),rngpctl(0.08);
vars: alphas(0.01),flens(46),rngpcts(0.26);
inputs: stopl(1000),funkl(1200),brkl(1900),tl(2900);
inputs: stops(1250),funks(1300),brks(1500),ts(2200);
