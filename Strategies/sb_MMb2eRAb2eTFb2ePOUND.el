{****** - MM.RA.TF.TBOND - ********
 ...
 Date:      21 Giu 2011
*************************************}
vars: alphal(0.01),flenl(24),rngpctl(0.03);
vars: alphas(0.08),flens(44),rngpcts(0.98);
inputs: stopl(176),funkl(172),modl(2.01),brkl(208),tl(4.19);
inputs: stops(256),funks(152),mods(1.06){,brks(100000),ts(200000)};
...
if 800 < t and t < 2300 then begin
 ...
 if marketposition = 1 then begin
  ...
  //TAKE PROFIT
  stpv = entryprice + IntPortion((1 + tl)*VolW)*MinMove points;
