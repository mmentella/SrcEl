Inputs: nos(2),lenl(20),kl(4.04),lens(51),ks(1.63),adxlen(16),adxlimit(30);
Inputs: stopl(225),stopdl(1000000),brkl(250),modl(1000000),tl(500),tld(1000000),trsl(1000000);
Inputs: stops(350),stopds(1000000),brks(700),mods(1000000),ts(1300),tsd(1000000),trss(1000000);

vars: upk(0,data2),lok(0,data2),adxval(0,data2),el(true,data2),es(true,data2),engine(true,data2),trade(true);
vars: stopval(0),minstop(-1),maxstop(999999),mkt(true),stp(true),mcp(0),mp(0),yc(0);
...
if marketposition <> 0 and 800 < t and t < 2010 then begin
...
condition1 = d < 1060921;
//if d = 1060921 then setexitonclose;
