Inputs: nos(1),lenl(14),consl(3),diffl(0),lens(14),conss(3),diffs(0),mnymngmnt(0);
Inputs: stopl(100000),stopdl(100000),funkl(100000),brkl(100000),modl(100000),tl(100000),tld(100000),trsl(100000);
Inputs: stops(100000),stopds(100000),funks(100000),brks(100000),mods(100000),ts(100000),tsd(100000),trss(100000);
...
//condition1 = 1030701 < d and d < 1081101 or d > 1100101;
