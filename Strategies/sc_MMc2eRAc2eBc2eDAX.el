...
var: upk(0,data1),lok(0,data1),el(true,data1),es(true,data1),goL(true),goS(true);
var: trades(0),dru(0),mcp(0),nos(1),fnkl(false),fnks(false),bpv(1/bigpointvalue);

var: orderL(true),orderS(true),controller(true),mp(0),t2(0,data1);
...
if not controller and (t[1] = t2 or t = sessionendtime(0,1) or barinterval = 15) then 
   controller = true;}
{***************************}
{***************************}
if barstatus(1) = 2 then begin
 upk = BollingerBand(h,lenl,kl)data1;
 lok = BollingerBand(l,lens,-ks)data1;
