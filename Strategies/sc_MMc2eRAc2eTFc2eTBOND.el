{****** - MM.RA.TF.TBOND - ********
 ...
 Portfolio: RA
 Market:    TBOND
 TimeFrame: 54 + 1350 min.
 BackBars:  50
 Date:      21 Giu 2011
*************************************}
vars: alphal(0.16),flenl(32),rngpctl(0.23);
vars: alphas(0.97),flens(5),rngpcts(0.41);
inputs: stopl(94),funkl(74),brkl(66),tl(72);
inputs: stops(92),funks(76),brks(34),ts(130);
