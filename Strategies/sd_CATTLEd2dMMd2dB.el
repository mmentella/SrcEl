Inputs: nos(2),lenl(47),kl(1.2),lens(28),ks(3.2),mnymngmnt(1);
Inputs: stopl(1900),funkl(1600),modl(1650);
Inputs: stops(1600),funks(1600),mods(1550),ts(1800);
...
//BROKEN INDEX
if d = 1090723 then setexitonclose;
condition1 = d < 1031223 or 1031231 < d;

if condition1 and not funk and trade < 1 and engine then begin
